/*
 * @(#)mclmcr.h    generated by: makeheader 5.1.5  Mon Jan  4 18:14:48 2010
 *
 *		built from:	../../src/include/copyright.h
 *				../../src/include/pragma_interface.h
 *				CxxUtils.cpp
 *				JavaVMConfigDeployed.cpp
 *				MWSparseArray.cpp
 *				MecMfileReader.cpp
 ...
 *				mclComponentCacheExtraction.cpp
 *				mclComponentData.cpp
 *				mclComponentDirectoryExtraction.cpp
 *				mclComponentExtraction.cpp
 *				mclComponentInit.cpp
...
typedef struct mcl_component_data
{
    ...
    /* standalone application main public function return parameter count */
    size_t main_fcn_return_count;
...
EXTERN_C mclCtfStream mclGetStreamFromArraySrc(char *buffer, int bufferSize);


EXTERN_C void mclDestroyStream(mclCtfStream pStream);


EXTERN_C mclCtfStream mclGetEmbeddedCtfStream(void* handle, unsigned long ctfContentsSize);


EXTERN_C bool mclInitializeComponentInstanceNonEmbedded( HMCRINSTANCE* inst,
                                                ...
                                                const char* ctfExtractionLocation);


EXTERN_C bool mclInitializeComponentInstanceNonEmbeddedStandalone(   HMCRINSTANCE* inst,
                                                            const mclComponentData* cdata,
                                                            bool replace_path,
                                                            mccComponentType ctype,
                                                            mccTargetType ttype,
...
EXTERN_C bool mclInitializeComponentInstancePreExtractedToCache( HMCRINSTANCE* inst,
                                                        const mclComponentData* cdata,
                                                        bool replace_path,
                                                        mccComponentType ctype,
                                                        mccTargetType ttype,
...
EXTERN_C bool mclInitializeComponentInstanceEmbedded(HMCRINSTANCE* inst,
                                            const mclComponentData* cdata,
                                            bool replace_path,
                                            mccComponentType ctype,
                                            mccTargetType ttype,
...
EXTERN_C bool mclInitializeComponentInstanceCtfFileToCache(  HMCRINSTANCE* inst,
                                                    const mclComponentData* cdata,
                                                    bool replace_path,
                                                    mccComponentType ctype,
                                                    mccTargetType ttype,
...
/** @brief Read ctf manifest file from ctf archive and load it into component data structure*/
    ...
    */
EXTERN_C mclComponentData* mclLoadCtfToComponentData(const char* ctfPath,mclOutputHandlerFcn error_handler,mclOutputHandlerFcn print_handler);
...
EXTERN_C int mclGetNumericSparseInferRowsCols(
    void** ppv,
    mwSize rowindex_size,
    const mwSize* rowindex,
    mwSize colindex_size,
...
EXTERN_C int mclGetLogicalSparseInferRowsCols(
    void** ppv,
    mwSize rowindex_size,
    const mwIndex* rowindex,
    mwSize colindex_size,
...
EXTERN_C int mclMXArrayGetIndexArrays(mxArray** ppRows, mxArray** ppColumns, mxArray* pSrcArray);


EXTERN_C int mclMXArrayGet(mxArray** ppSrcElem, mxArray* pSrcArray, mwSize num_indices, const mwIndex* index);
...
EXTERN_C int mclMXArraySetReal(mxArray* pTrgArray, mxArray* pSrcElem, mwSize num_indices, const mwIndex* index);


EXTERN_C int mclMXArraySetImag(mxArray* pTrgArray, mxArray* pSrcElem, mwSize num_indices, const mwIndex* index);
