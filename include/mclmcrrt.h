/*
 * @(#)mclmcrrt.h    generated by: makeheader 5.1.5  Mon Jan  4 18:15:26 2010
 *
...
/* Map original name to unique proxy layer name. */
#undef mclLoadCtfToComponentData
#define mclLoadCtfToComponentData mclLoadCtfToComponentData_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclInitializeComponentInstancePreExtractedToCache
#define mclInitializeComponentInstancePreExtractedToCache mclInitializeComponentInstancePreExtractedToCache_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclInitializeComponentInstanceNonEmbedded
#define mclInitializeComponentInstanceNonEmbedded mclInitializeComponentInstanceNonEmbedded_proxy
...
EXTERN_C
mclComponentData * mclLoadCtfToComponentData_proxy(const char *a0, 
...
EXTERN_C
bool mclInitializeComponentInstanceNonEmbedded_proxy(HMCRINSTANCE *a0, 
    const mclComponentData *a1, bool a2, mccComponentType a3, 
    mccTargetType a4, mclOutputHandlerFcn a5, mclOutputHandlerFcn a6, 
